...
You should determine whether all passengers can ride the bus, that is,
whether the number of passengers currently on the bus doesn't exceed the capacity at any moment. 
In the first line, you're given the capacity. In the next line, you're given the number of passengers N. 
In the next N lines, you're given the time each passenger boarded and got off the bus in the format HH:MM.

To solve this problem you should use an appropriate data structure that will let you achieve 
the desired result with minimal complexity. The bus rides until  23:59.
...
Input: In the first line, you're given the capacity. In the next line, 
you're given the number of passengers N. In the next N lines, 
