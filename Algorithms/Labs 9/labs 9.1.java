/*
Using a binary tree and preorder traversal check if every next element 
is equal to the previous element + 2. You are allowed to use additional 
functions, recursion, and additional structures.
*/
