...
Be careful when adding new directory/file, it should be put in a position such that all 
directories/files in the current folder will be sorted lexicographically.
...
PRINT - prints the whole file system structure such that each directory/file is printed in a 
new line with spaces equal to level of that directory/file.
